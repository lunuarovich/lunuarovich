...
# 💻Featured Projects:
- [Хатинка Лапок](https://avaliany.github.io/pets-team-project/) – Responsive pet adoption platform featuring adaptive UI, modal interactions, API integration, and user-friendly forms with validation.
 Built using CSS3, JavaScript, HTML5.

- [Coffee Joy](https://aida-zborovska.github.io/OneSecond-team-project/) – A responsive landing page for an coffee brand developed in a team, with a focus on responsive design and semantic HTML. Built using HTML5, CSS3 (SASS), and JavaScript.
